...
class Player:
    ...
    def add_mob_turn(self, name):
        with open('database/turns_took.csv', mode='a', newline='') as file:
            message = [name, self.turns[name]]
            writer = csv.writer(file)
            writer.writerows([message])
    
    def add_first_weapon(self):
        with open('database/first_weapon.csv', mode='a', newline='') as file:
            writer = csv.writer(file)
            writer.writerow([str(self.first_buy)])

    def add_first_mob(self):
        with open('database/first_mob.csv', mode='a', newline='') as file:
            writer = csv.writer(file)
            writer.writerow([str(self.first_encounter)])

    def add_first_dead(self):
        with open('database/first_dead.csv', mode='a', newline='') as file:
            writer = csv.writer(file)
            writer.writerow([str(self.first_dead)])

    def add_all_kills(self):
        with open('database/all_kills.csv', mode='a', newline='') as file:
            writer = csv.writer(file)
